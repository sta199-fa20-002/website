...
difference you investigated in Exercise 1 using your bootstrap distribution.
...
the mean uniformity of burritos with sour cream is higher than burritos without 
sour cream using a CLT-based approach.
5. Construct and interpret a a 95% two-sided confidence interval for the 
difference you investigated in Exercise 4.
