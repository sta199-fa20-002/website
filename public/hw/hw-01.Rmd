...
We have (simulated) data from Lego sales in 2018 for a sample of customers who bought Legos in the US.  The dataset is called `lego_sales` and can be found in the data folder in your repo. You can find descriptions of each of the variables in the help file for the dataset, which you can access by running `?lego_sales` in the **console**.
