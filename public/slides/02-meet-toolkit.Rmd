...
Each assignment, application exercise, and lab in this course will have an associated link used to create a private **repository** on the class organization page.
