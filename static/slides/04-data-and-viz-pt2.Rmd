...
.question[
Which bar plot is a more useful representation for visualizing the relationship between hair color and eye color? Why?
]

```{r echo=FALSE, fig.width=10, fig.height = 5}
p1 <- ggplot(data = starwars, mapping = aes(x = hair_color, fill = eye_color2)) +
  geom_bar() 

p2 <- ggplot(data = starwars, mapping = aes(x = hair_color, fill = eye_color2)) +
  geom_bar(position = "fill") +
  labs(y = "proportion") 
...
```{r datasaurus-plot, echo=FALSE, fig.height=5, fig.width=10}
