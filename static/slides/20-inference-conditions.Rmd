...
$H_a: \beta_1 \ne 0$. There is a relationship between mileage and age. The slope is not 0.
]
...
The p-value is in the output is the p-value associated with the two-sided hypothesis test $H_a: \beta_k \neq 0$. 
...
.vocab[The p-value is very small, so we reject] $\color{#00b3b3}{H_0}$.vocab[The data provide sufficient evidence that the coefficient of age is not equal to 0 and there is a linear relationship between the mileage and age of a car.]  
---
