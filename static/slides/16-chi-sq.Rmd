...
- $H_a$: Coffee-drinking category and mortality are NOT independent; there is
...
vs. the expected counts that we would expect if $H_0$ were true. If these total differences are "large enough," then we reject the null hypothesis.
