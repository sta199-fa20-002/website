...
```{marginfigure}
See [Two numerical vars - correlation](https://infer.netlify.app/articles/observed_stat_examples.html#hypothesis-tests-1) on the infer website for help with code.
```
