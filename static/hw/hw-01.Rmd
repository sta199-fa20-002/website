...
In this assignment we will work with the `tidyverse` as usual and the **dsbox** package for the data.
...
We have (simulated) data from Lego sales in 2018 for a sample of customers who bought Legos in the US.  The dataset is called `lego_sales` and is in the `dsbox` R package. You can find descriptions of each of the variables in the help file for the dataset, which you can access by running `?lego_sales` in the **console**.
