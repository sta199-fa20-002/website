...
- [HW 01](https://sta199-fa20-002.netlify.app/hw/hw-01.html) due Sep 16 at 11:59p
...
Go to the `ae-08-[GITHUB USERNAME]` repo, clone it, and start a new project in RStudio. See the [Lab 01](https://sta199-fa20-002.netlify.app/labs/lab-01-hello-r.html#getting-started) for more detailed instructions about cloning a repo and starting a new project. 
